...
export default function Example() {
  ...
  return (
    <>
      {/*
        This example requires updating  template:
      ...
      */}
      <div>
            ...
            <div className="fixed inset-0 flex">
              ...
              >
                <Dialog.Panel className="relative mr-16 flex w-full max-w-xs flex-1">
                  ...
                  <Card className="flex grow flex-col gap-y-5 overflow-y-auto  px-6 pb-2">
                            ...
                            {narators.map((narator) => (
                              <li key={narator.name}>
                                ...
                                >
                                  ...
                                  <span className="truncate">{narator.name}</span>
                                </a>
                              </li>
                            ))}
                          </ul>
        ...
        <Card className=" bg-black sticky top-0 z-40 flex items-center gap-x-6  px-4 py-4 shadow-sm sm:px-6 lg:hidden">
          <button
            type="button"
